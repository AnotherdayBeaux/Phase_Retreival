...
Tol=1e-14;
SUB_IM=100;
last=50;  %get convergence rate  2*last interval calculation.
...
figure
plot(Gamma,CR_pois,'g')
hold on
plot(Gamma,CR_gau,'r')
xlabel('gamma')
ylabel('conv rate')
legend('pois','gau')
name='/Users/Beaux/Desktop/phase retrieval/code/report 3.8/gamma_verse_CR';
saveas(gcf, name, 'png')
close


figure
plot(Gamma,num_iter_pois,'g')
hold on
plot(Gamma,num_iter_gau,'r')
xlabel('gamma')
ylabel('num iteration')
legend('pois','gau')
name='/Users/Beaux/Desktop/phase retrieval/code/report 3.8/gamma_verse_numiter';
saveas(gcf, name, 'png')
close
...
ylabel('conv rate')
legend('pois','gau')
name='/Users/Beaux/Desktop/phase retrieval/code/report 3.8/rho_verse_CR';
saveas(gcf, name, 'png')
close
