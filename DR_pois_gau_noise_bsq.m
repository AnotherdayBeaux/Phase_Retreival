...
%%%%
%%%% noise are added to b^2 gaussian
%%%%
...
plot(NSR_V,end_error(4,:),'ro:')
hold on
plot(NSR_V,end_error(5,:),'go:')
hold on
plot(NSR_V,end_error(6,:),'bo:')
grid on
xlabel('NSR')
ylabel('Rel Error')
legend('DR gau rho=2','DR gau rho=1','DR gau rho=0.5','DR pois rho=2','DR pois rho=1','DR pois rho=0.5');   


saveas(gcf,'/Users/Beaux/Desktop/phase retrieval/code/2/DR_pois_gau_noise_bsq','png')