...
DENSR=3:2:20; % noise level used in the test
...
plot(NSR_V,end_error(6,:),'ro:')
grid on
plot(NSR_V,end_error(7,:),'go:')
grid on
plot(NSR_V,end_error(8,:),'bo:')
grid on
plot(NSR_V,end_error(9,:),'co:')
grid on
...
saveas(gcf,'/Users/Beaux/Desktop/phase retrieval/code/2/DR_pois_gau_noise_pois_3000iter','png')