%%%% use FFT to calculate (A_star*D)*x; RanS*FFT(x) where RanS is a diag
%%%% matrix with 0,1 on diag. 



function Y= random_sample_fft(X,os_rate,num_mask,mask,RanS)
[Na,Nb]=size(X);
...
switch num_mask   % 0  0 mask / Id mask
                  ...
                  % 4  3 mask, 1 id and 2 random ones.
    case 0
