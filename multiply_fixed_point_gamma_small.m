...
figure
semilogy(1:3000,residual_DR_y(1,1:3000),'g')
hold on
semilogy(1:3000,residual_DR_y(2,1:3000),'r')
hold on
semilogy(1:3000,residual_DR_y(3,1:3000),'b')
hold on
semilogy(1:3000,residual_DR_y(4,1:3000),'k')
xlabel('iteration')
ylabel('residual')
title('semilogy of convergence, with knowledge of phase')
Sname=[name,'/rho large knowledge of phase'];
saveas(gcf,Sname,'png')

figure
semilogy(1:20000,residual_DR_y_noini(1,1:20000),'g')
hold on
semilogy(1:20000,residual_DR_y_noini(2,1:20000),'r')
hold on
semilogy(1:20000,residual_DR_y_noini(3,1:20000),'b')
hold on
semilogy(1:20000,residual_DR_y_noini(4,1:20000),'k')
xlabel('iteration')
ylabel('residual')
title('semilogy of convergence, without knowledge of phase')
legend('1','2','3','4')    

Sname=[name,'/rho large no knowledge of phase'];
saveas(gcf,Sname,'png')
