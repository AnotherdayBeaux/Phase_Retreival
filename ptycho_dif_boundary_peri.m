...
DENSR=10:6:40;      %DENSR=15:20; % noise level used in the test
...
Bigname='/Users/Beaux/Desktop/phase retrieval/code/16/ptycho_boundary_periperi';
mkdir(Bigname);
...
xlabel('NSR')
ylabel('Rec Err')
title('NSR verse Err peri ')
legend('q=4','q=8','q=16','q=32','q=64')

name_plot=[Bigname,'/NSR verse Err peri'];
saveas(gcf,name_plot,'png')